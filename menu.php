    ...
    <section class="category">
      ...
      <div class="product-grid">
        <div class="product">
          ...
          <img src="./images/arabica-beans.jpg" alt="Arabica Beans" class="product-image">
        ...
        <div class="product">
          ...
          <img src="./images/robusta-beans.jpg" alt="Robusta Beans" class="product-image">
        ...
        <div class="product">
          ...
          <img src="./images/chocolate-bar.jpg" alt="Chocolate Bar" class="product-image">
        ...
        <div class="product">
          ...
          <img src="./images/vanilla-cookies.jpg" alt="Vanilla Cookies" class="product-image">
        ...
        <div class="product">
          ...
          <img src="./images/caramel-squares.jpg" alt="Caramel Squares" class="product-image">
    ...
    <section class="category">
      ...
      <div class="product-grid">
        <div class="product">
          ...
          <img src="./images/butter-croissant.jpg" alt="Butter Croissant" class="product-image">
        ...
        <div class="product">
          ...
          <img src="./images/chocolate-croissant.jpg" alt="Chocolate Croissant" class="product-image">
        ...
        <div class="product">
          ...
          <img src="./images/cheesecake.jpg" alt="Cheesecake" class="product-image">
          <button class="add-to-cart" onclick="addToCart('Cheesecake', 6.00)">Add to Cart - $6.00</button>
        </div>
        <div class="product">
          <p class="product-name">Fruit Tart - $5.50</p>
          <img src="./images/fruit-tart.jpg" alt="Fruit Tart" class="product-image">
        ...
        <div class="product">
          ...
          <img src="./images/red-velvet-cake.jpg" alt="Red Velvet Cake" class="product-image">
